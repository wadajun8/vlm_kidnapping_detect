...
in	float	oTexcoord1_1;
in	vec4	oTexcoord4_2;
...
void main(void) {
	...
	SGX_ComputeShadowFactor_PSSM3(oTexcoord1_1, pssm_split_points2, oTexcoord4_2, oTexcoord4_3, oTexcoord4_4, shadow_map0, shadow_map1, shadow_map2, inv_shadow_texture_size3, inv_shadow_texture_size4, inv_shadow_texture_size5, lShadowFactor);
