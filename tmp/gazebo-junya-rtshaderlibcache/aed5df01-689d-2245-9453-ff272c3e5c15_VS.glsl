...
out	float	oTexcoord1_1;
out	vec4	oTexcoord4_2;
...
void main(void) {
	...
	FFP_Assign(gl_Position.z, oTexcoord1_1);

	FFP_Transform(world_texture_view_proj0, vertex, oTexcoord4_2);

	FFP_Transform(world_texture_view_proj1, vertex, oTexcoord4_3);

	FFP_Transform(world_texture_view_proj2, vertex, oTexcoord4_4);
